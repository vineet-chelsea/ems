...
def get_sample_value(parameter, data_type):
    ...
    if data_type == "FLOAT32":
        ...
        if "name" in param_lower:
            return encode_utf8("EM6400 Meter")
        elif "model" in param_lower:
            return encode_utf8("EM6400")
...
# Read the JSON file
with open('backend/src/config/em6400_mappings.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

# Open output file for writing
output_file = 'em6400_sample_values.txt'
